...
<div className="flex justify-center mt-5">
    <div className="w-full max-w-sm">
        <form
            className="bg-white rounded shadow-md px-8 pt-6 pb-8 mb-4 border-radius 20px"
        ...
        >
            ...
            <input
                type="submit"
                className="bg-green-900 w-full mt-5 p-2 text-white uppercas hover:cursor-pointer hover:bg-green-700"
